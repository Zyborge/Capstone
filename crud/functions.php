...
function validateAndInsertData($mysqli, $data) {
    ...
    // Validate Gender
    $genders = is_array($_POST['gender']) ? $_POST['gender'] : [$_POST['gender']];
    ...
    // Validate Street
    $streets = is_array($_POST['street']) ? $_POST['street'] : [$_POST['street']];
    ...
    $maritalstatuses = is_array($_POST['maritalstatus']) ? $_POST['maritalstatus'] : [$_POST['maritalstatus']];
    ...
    if (empty($errors)) {
        ...
        // Validation errors occurred, return the errors
        return $errors;
    }
}
